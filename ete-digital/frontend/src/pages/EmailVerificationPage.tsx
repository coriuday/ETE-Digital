                    ...
                    {state === 'success' && (
                        <>
                            ...
                            <p className="text-gray-500 text-sm mb-6">
                                Your account is now active. You can log in and start using ETE Digital.
                            </p>
                            <Link
                                to="/login"
                                className="inline-block px-8 py-3 bg-gradient-to-r from-primary-600 to-secondary-700 text-white rounded-xl font-semibold hover:opacity-90 transition-opacity"
                            >
                                Go to Login
                            </Link>
                        </>
                    ...
                    {state === 'error' && (
                        <>
                            ...
                            <div className="flex gap-3 justify-center">
                                <Link
                                    to="/register"
                                    className="px-6 py-2.5 bg-primary-600 text-white rounded-xl text-sm font-semibold hover:opacity-90"
                                >
                                    Register Again
                                </Link>
                                <Link
                                    to="/contact"
                                    className="px-6 py-2.5 border border-gray-300 text-gray-700 rounded-xl text-sm font-semibold hover:border-primary-400"
                                >
                                    Contact Support
                                </Link>
                            </div>
