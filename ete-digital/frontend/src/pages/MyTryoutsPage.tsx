                                ...
                                {(submission.auto_score !== undefined || submission.manual_score !== undefined) && (
                                    <div className="grid grid-cols-3 gap-4 mb-4 p-4 bg-gray-50 rounded-lg">
                                        {submission.auto_score !== undefined && (
                                            <div>
                                                <p className="text-xs text-gray-600 mb-1">Auto Score</p>
                                        ...
                                        {submission.manual_score !== undefined && (
                                            <div>
                                                <p className="text-xs text-gray-600 mb-1">Manual Score</p>
                                        ...
                                        {submission.final_score !== undefined && (
                                            <div>
                                                ...
                                                <p className={`text-2xl font-bold ${submission.status === 'PASSED' ? 'text-green-600' : 'text-red-600'}`}>
                                ...
                                <div className="space-y-2 text-sm">
                                    {submission.submission_url && (
                                        <p>
                                            ...
                                            <a href={submission.submission_url} target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:text-primary-700">
                                                {submission.submission_url}
                                            </a>
                                        </p>
                                    )}
                                    {submission.notes && (
                                        <p>
                                            ...
                                            <span className="text-gray-900">{submission.notes}</span>
                                        </p>
                                    )}
                                </div>
