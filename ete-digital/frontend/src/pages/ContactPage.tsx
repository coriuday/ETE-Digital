...
export default function ContactPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setError('');
        try {
            // In production, this would call a contact API. For now, simulate success.
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className="bg-primary-50 rounded-2xl p-6">
                                ...
                                <p className="text-sm text-gray-600 leading-relaxed">
                                    Looking for custom integrations, white-labeling, or bulk hiring solutions?
                                    Our enterprise team will set up a dedicated call.
                                </p>
                            </div>
                        </div>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-5">
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none"
                                                />
                                            </div>
                                            <div>
                                        ...
                                        <div>
                                            ...
                                            <select
                                                ...
                                                onChange={handleChange}
                                                required
                                                className="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none bg-white"
                                            >
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                className="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none resize-none"
                                            />
                                        </div>
                                        {error && (
                                        ...
                                        <button
                                            type="submit"
                                            disabled={loading}
                                            className="w-full py-3 bg-gradient-to-r from-primary-600 to-secondary-700 text-white rounded-xl font-semibold hover:opacity-90 transition-opacity disabled:opacity-60 flex items-center justify-center gap-2"
                                        >
