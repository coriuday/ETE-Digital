                ...
                <div className="bg-white rounded-2xl shadow-2xl p-8">
                    {success ? (
                        <div className="text-center">
                            ...
                            <Link to="/login" className="mt-4 inline-block text-primary-600 text-sm font-medium hover:underline">
                                Go to Login now
                            </Link>
                        </div>
                    ) : (
                        <>
                            ...
                            {error && !token ? (
                                <div className="text-center">
                                    ...
                                    <Link to="/forgot-password" className="text-primary-600 text-sm font-medium hover:underline">
