        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
            <div className="max-w-lg w-full text-center">
                ...
                <div className="relative mb-8">
                    <div className="text-[10rem] font-black text-gray-200 leading-none select-none">
                        404
                    </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    ...
                    <Link
                        to="/"
                        className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-primary-600 to-secondary-700 text-white rounded-xl font-semibold hover:opacity-90 transition-opacity shadow-lg shadow-primary-200"
                    >
