...
export default function GradeTryoutsPage() {
    ...
    const loadSubmissions = async () => {
        try {
            // In real app: await tryoutsApi.getSubmissions(tryoutId)
            // Mock data for now
            setSubmissions([]);
            setLoading(false);
        } catch (error) {
                ...
                <div className="bg-white rounded-lg shadow p-4 mb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg transition ${filter === 'pending' ? 'bg-primary-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg transition ${filter === 'graded' ? 'bg-primary-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                }`}
                        >
                    ...
                    <div className="bg-white rounded-lg shadow p-12 text-center">
                        ...
                        <p className="text-gray-600">
                            {submissions.length === 0
                                ? 'No tryout submissions received yet'
