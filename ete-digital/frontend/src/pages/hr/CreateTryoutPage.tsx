        ...
        <div className="min-h-screen bg-gray-50">
            <div className="bg-surface shadow">
                <div className="container mx-auto px-4 py-6">
                    <h1 className="text-3xl font-bold text-text-primary">Create Tryout</h1>
                    <p className="text-text-secondary mt-1">Create a paid trial task for candidates</p>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 py-8">
                <form onSubmit={handleSubmit} className="max-w-3xl mx-auto space-y-6">
                    ...
                    <div className="bg-surface rounded-lg shadow p-6">
                        <h2 className="text-xl font-semibold text-text-primary mb-4">Job Details</h2>
                        <div>
                            <label className="block text-sm font-medium text-text-primary mb-2">Select Job *</label>
                    ...
                    {/* Task Details */}
                    <div className="bg-surface rounded-lg shadow p-6">
                        <h2 className="text-xl font-semibold text-text-primary mb-4">Task Information</h2>
                        <div className="space-y-4">
                            <div>
                                <label className="block text-sm font-medium text-text-primary mb-2">Tryout Title *</label>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-text-primary mb-2">Instructions *</label>
                    ...
                    {/* Time & Payment */}
                    <div className="bg-surface rounded-lg shadow p-6">
                        <h2 className="text-xl font-semibold text-text-primary mb-4">Time & Compensation</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-medium text-text-primary mb-2">Time Limit (hours) *</label>
                    ...
                    <div className="bg-surface rounded-lg shadow p-6">
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-xl font-semibold text-text-primary">Scoring Rubric</h2>
                        ...
                        {formData.rubric.map((item, index) => (
                            <div key={index} className="flex gap-4 mb-3">
                                <input type="text" value={item.criterion} onChange={(e) => updateRubric(index, 'criterion', e.target.value)}
                                    ...
                                    className="flex-1 px-4 py-2 border border-border rounded-lg focus:ring-2 focus:ring-primary-500" />
                                <input type="number" value={item.points} onChange={(e) => updateRubric(index, 'points', parseInt(e.target.value) || 0)}
                                    ...
                                    className="w-24 px-4 py-2 border border-border rounded-lg focus:ring-2 focus:ring-primary-500" />
                    ...
                    <div className="flex justify-end gap-4">
                        <button type="button" onClick={() => navigate(-1)}
                            className="px-6 py-3 text-text-primary bg-surface border border-border rounded-lg hover:bg-background transition font-medium">
                            Cancel
                        </button>
